...
而当整个页从B+树里面摘掉以后，可以复用到任何位置。以图1为例，如果将数据页page
A上的所有记录删除以后，page
...
> \@某、人 给了一个形象的描述，而且提到了，在这种情况下，连change
...
- ![](../images/question.png)
    ...
    麻烦咨询个问题，"在图 3 中，我们把表 A 中的数据导出来的存放位置叫作
...
- ![](../images/question.png)
    ...
    1. 是不是 5.6 之后 所有的 alter 操作(增删字段、增删索引等)都是支持
    online ddl
